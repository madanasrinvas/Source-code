...
import static Main.GSFO.moveX;
import static Main.GSFO.moveY;
...
public class Charging extends JPanel { 

public static JFrame Frame6;
   ...
   protected void paintComponent(Graphics g) {
      ...
      switch (GSFO.B) {
           case 1:
               ...
               g2.setColor(Color.DARK_GRAY);
               g2.fillOval(moveX, moveY, BatterySize, BatterySize); 
               g2.setStroke(new BasicStroke(3));   
               g2.drawLine(moveX,moveY,Network.B1X,Network.B1Y );
               break;
           case 2:
               ...
               g2.fillOval(moveX, moveY, BatterySize, BatterySize); 
               g2.setStroke(new BasicStroke(3));   
               g2.drawLine(moveX,moveY,Network.B2X,Network.B2Y );
               break;
           case 3:
               ...
               g2.fillOval(moveX, moveY, BatterySize, BatterySize); 
               g2.setStroke(new BasicStroke(3));   
               g2.drawLine(moveX,moveY,Network.B3X,Network.B3Y );
               break;
           case 4:
               ...
               g2.fillOval(moveX, moveY, BatterySize, BatterySize); 
               g2.setStroke(new BasicStroke(3));   
               g2.drawLine(moveX,moveY,Network.B4X,Network.B4Y );
               break;
           default:
               break;
       }
   ...
   private static void createAndShowGui() {
      ...
      Frame6 = new JFrame("Charging");
      Frame6.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
      Frame6.getContentPane().add(ch);
      Frame6.pack();
      Frame6.setLocationByPlatform(true);
